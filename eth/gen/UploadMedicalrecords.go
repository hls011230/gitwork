...
// UploadMedicalrecords_gainercertificate is an auto generated low-level Go binding around an user-defined struct.
type UploadMedicalrecords_gainercertificate struct {
	User     common.Address
	Time     *big.Int
	BlockNum *big.Int
	Serial   [32]byte
...
func (_Gen *GenCaller) ViewUserCertificate(opts *bind.CallOpts, _user common.Address, _num [32]byte) (UploadMedicalrecords_gainercertificate, error) {
	var out []interface{}
	err := _Gen.contract.Call(opts, &out, "ViewUserCertificate", _user, _num)

	if err != nil {
		return *new(UploadMedicalrecords_gainercertificate), err
	}

	out0 := *abi.ConvertType(out[0], new(UploadMedicalrecords_gainercertificate)).(*UploadMedicalrecords_gainercertificate)
...
//
// Solidity: function ViewUserCertificate(address _user, bytes32 _num) view returns((address,uint256,uint256,bytes32,string[],string[]))
func (_Gen *GenSession) ViewUserCertificate(_user common.Address, _num [32]byte) (UploadMedicalrecords_gainercertificate, error) {
...
//
// Solidity: function ViewUserCertificate(address _user, bytes32 _num) view returns((address,uint256,uint256,bytes32,string[],string[]))
func (_Gen *GenCallerSession) ViewUserCertificate(_user common.Address, _num [32]byte) (UploadMedicalrecords_gainercertificate, error) {
	return _Gen.Contract.ViewUserCertificate(&_Gen.CallOpts, _user, _num)
}
